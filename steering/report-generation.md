...
[All links verified via AWS Documentation MCP server. Do NOT fabricate URLs.]
...
Use the AWS Documentation MCP server to find verified URLs. Prefer:
...
Write to the workspace root. Kiro restricts file access to the workspace only.
